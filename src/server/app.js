   ...
   */
    constructor(c) {
        ...
        this.app.use((req, res, next) => {
            if(req.headers.host.toLowerCase() !== 'tanner.pw') {
                res.statusCode = 401;
        ...
        this.app.get('/photography', routes.photography.bind(this));
        this.app.get('/admin', routes.login.bind(this));
        this.app.get('/b', routes.blog.get.bind(this));
        ...
        this.app.post('/b', routes.blog.post.bind(this));
